...
[Home](../../README.md) › [Learning Platforms](README.md) › **Metasploitable 2/3**
...
Metasploitable 2/3 — Intentionally vulnerable Linux/Windows targets for exploitation practice. This page gives a beginner→expert roadmap and how to get the most from it while keeping everything lawful and, where possible, offline.
...
_Learning platform · Vulnerable VM · Last updated 2026-08-13._
